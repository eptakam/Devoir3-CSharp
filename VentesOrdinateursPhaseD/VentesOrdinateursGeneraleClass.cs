...
namespace VentesOrdinateurs
{
    ...
    internal class VentesOrdinateursGeneraleClass
    {
        ...
        public static string[] tMessagesErreurStr = new string[5];  // Tableau des messages d'erreurs
        ...
        public static void InitMessagesErreurs()
        {
            ...
            tMessagesErreurStr[(int)ce.ceErreurAboutBox] = "Erreur reliée au formulaire à propos de....";
